function ResizeImage_class() {
	...
	/**
	 * ResizeImage resize. Detect cpu count and use best option for user.
	 * 
	...
	/**
	 * ResizeImage resize. Resize actual image.
	 * 
	...
	/**
	 * ResizeImage resize, multicore version - fast image resize/resample using ResizeImage filter.
	 * 
	 * @param {HtmlElement} canvas
	 * @param {int} width
	 * @param {int} height
	...
	/**
	 * ResizeImage resize - fast image resize/resample using ResizeImage filter. 1 cpu version!
	 * 
	 * @param {HtmlElement} canvas
	 * @param {int} width
	 * @param {int} height
